...
SELECT
    callid,
    UnitNumber                AS unit_delivering_16th_firefighter,
    ArriveDateTime            AS arrival_time_16th_firefighter,
    total_response_time_sec   AS total_response_time_sec_16th
FROM SixteenthFirefighter
WHERE rn = 1
