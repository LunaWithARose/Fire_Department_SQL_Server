...
BaseData AS (
    ...
    WHERE CreateDatetime BETWEEN @StartDateTime AND @EndDateTime
      ...
      AND Quadrant IN ('AD1218c', 'AD1118', 'AD1119c', -- Checks for urban quandrant
					   'AD1119d', 'AD1018b', 'AD1018c', 
                       'AD1018d', 'AD1019', 'AD0918a', 
                       'AD0918c', 'AD1919')
      AND UnitNumber REGEXP '^(M)' -- checks for is the units responding are medic
